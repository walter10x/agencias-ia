...
from app.domain.shared.errors import AgentNotFoundError, ForbiddenError, InvalidAgentError
...
class UpdateAgentUseCase:
    ...
    async def execute(self, input: UpdateAgentInput, client_id: str | None = None) -> AgentOutput:
